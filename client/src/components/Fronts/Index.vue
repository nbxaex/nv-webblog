    ...
    <div>
      ...
      <div class="container">
        <div class="hero">
          ...
          <center><h1>แนะนำอุปกรณ์กีฬา</h1></center>
          <p></p>
        </div>
        ...
        <div class="blog-header">
          <div>
            <form class="form-inline form-search">
              <span><strong> จำนวนข้อมูล  : </strong> {{ results.length }} </span>
              &nbsp;
        ...
        <transition-group name="fade">
          <div v-for="blog in blogs" v-bind:key="blog.id" class="blog-list">
            ...
            <!--<div v-html="blog.content.slice(0, 600) +'...'"></div>-->
            <div class="blog-info">
              <p><strong>ประเภท :</strong> {{ blog.category }}</p>
              <!--<p><strong>อัพเดทล่าสุด :</strong> {{ blog.createdAt }}</p>-->
        ...
        <center><div v-if="blogs.length === 0 && loading === false" class="emptyblog">
          *** ไม่มีข้อมูล ***
        </div></center>
